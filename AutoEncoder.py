...
X = img_data
X_train, X_test, = train_test_split(X, train_size=0.85, random_state=random.randrange(10))
...
history = autoencoder.fit(x=X_train, y=X_train, epochs=20, batch_size=64, shuffle=True,
